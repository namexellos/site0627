...
<%
	...
	//해결책(모든 플랫폼에서 실행되려면 예) 리눅스, 유닉스, 맥 등등....
	//경로를 수정해야한다...
	...
	//String saveDirectory="C:/JAVA/final_workspace/site0627/WebContent/data";
	...
	//생성자에서 업로드가 수행됨!!
	int maxSize=5*1024*1024;//5메가     1024는 1kb는 1024 byte 1kb->1mb 1024kb
